...
public final class ArcUtils {
  ...
  @NonNull
  public static PointF pointFromAngleRadians(@NonNull PointF center, float radius,
      double angleRadians) {
  ...
  @NonNull
  public static PointF pointFromAngleDegrees(@NonNull PointF center, float radius,
      float angleDegrees) {
  ...
  @NonNull
  public static Path createBezierArcRadians(@NonNull PointF center, float radius,
  ...
  @NonNull
  public static Path createBezierArcDegrees(@NonNull PointF center, float radius,
      float startAngleDegrees,
      float sweepAngleDegrees, int pointsOnCircle, boolean overlapPoints,
      @Nullable Path addToPath) {
    return createBezierArcRadians(center, radius, toRadians(startAngleDegrees),
        toRadians(sweepAngleDegrees),
