...
public class SimpleActivity extends AppCompatActivity {
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    pvSimple.setItems(Uri.parse(
        "https://novel.tl/images/thumb/9/97/mknr_v1_303c4fed-c47f-40f2-8e54-709ae1e1f3ab_cover1"
            + ".jpg/720px-mknr_v1_303c4fed-c47f-40f2-8e54-709ae1e1f3ab_cover1.jpg"),
        Uri.parse("https://novel.tl/images/thumb/5/54/OreGairu_v01_a.jpg/720px-OreGairu_v01_a.jpg"),
    ...
    pvSimple.setDraweeHierarchyBuilder(GenericDraweeHierarchyBuilder.newInstance(getResources())
        .setProgressBarImage(new CircleProgressBarDrawable()));
    pvSimple.setOnDismissListener(this::finish);
    pvSimple.setOnClickListener(
        (v) -> Toast.makeText(this.getApplicationContext(), "CLICK", Toast.LENGTH_SHORT).show());

    pvSimple.setViewTapListener((v, e) -> Toast.makeText(this.getApplicationContext(),
        "ON TAP\n" + "Y: " + e.getY() + " | X: " + e.getX(), Toast.LENGTH_SHORT).show());
  }
}
