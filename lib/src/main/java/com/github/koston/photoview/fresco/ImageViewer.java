...
public class ImageViewer implements OnDismissListener, DialogInterface.OnKeyListener {
    ...
    private void createDialog() {
        ...
        dialog =
            new AlertDialog.Builder(builder.context, R.style.AppTheme_Transparent)
                .setView(viewer)
    ...
    /**
     * Resets image on {@literal KeyEvent.KEYCODE_BACK} to normal scale if needed, otherwise - hide
     * the viewer.
     */
    @Override
    ...
    public static class Builder<T> {
        ...
        /**
         * Constructor using a context and images urls array for this builder and the {@link
        ...
        public Builder(Context context, String image, String origSize, String replacement) {
            this(context, (T) image.replace(origSize, replacement));
        }

        /**
         * Constructor using a context and images urls list for this builder and the {@link ImageViewer}
         * it creates.
         */
        ...
        private Builder(Context context, T image) {
            this.context = context;
            this.dataSet = new DataSet<>(Collections.singletonList(image));
        }

        /**
         * If you use an non-string collection, you can use custom {@link Formatter} to represent it as
         * url.
         */
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        Builder setBackgroundColor(@ColorInt int color) {
        ...
        /**
         * Set {@code start}, {@code top}, {@code end} and {@code bottom} padding for zooming and
         * scrolling area in px.
         *
         * @return This Builder object to allow for chaining of calls to set methods
         */
        Builder setContainerPaddingPx(int start, int top, int end, int bottom) {
        ...
        /**
         * Set {@code start}, {@code top}, {@code end} and {@code bottom} padding for zooming and
         * scrolling area using dimension.
         *
         * @return This Builder object to allow for chaining of calls to set methods
         */
        ...
        /**
         * Set @{@code ImageRequestBuilder} for drawees. Use it for post-processing, custom resize
         * options etc. Use {@link ImageViewer#createImageRequestBuilder()} to create its new instance.
         *
         * @return This Builder object to allow for chaining of calls to set methods
         */
        ...
        /**
         * Set {@link GenericDraweeHierarchyBuilder} for drawees inside viewer. Use it for drawee
         * customizing (e.g. failure image, placeholder, progressbar etc.) N.B.! Due to zoom logic there
         * is limitation of scale type which always equals FIT_CENTER. Other values will be ignored
         *
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public Builder setCustomDraweeHierarchyBuilder(
            GenericDraweeHierarchyBuilder customHierarchyBuilder) {
            this.customHierarchyBuilder = customHierarchyBuilder;
            return this;
        }

        /**
         * Creates a {@link ImageViewer} with the arguments supplied to this builder. It does not {@link
         * ImageViewer#show()} the dialog. This allows the user to do any extra processing before
         * displaying the dialog. Use {@link #show()} if you don't have any other processing to do and
         * want this to be created and displayed.
         */
        ImageViewer build() {
        ...
        /**
         * Creates a {@link ImageViewer} with the arguments supplied to this builder and {@link
