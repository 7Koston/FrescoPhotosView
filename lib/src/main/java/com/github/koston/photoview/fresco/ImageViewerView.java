...
class ImageViewerView extends RelativeLayout
    ...
    public void setCustomDraweeHierarchyBuilder(
        GenericDraweeHierarchyBuilder customDraweeHierarchyBuilder) {
    ...
    public void setContainerPadding(int[] paddingPixels) {
        pager.setPadding(paddingPixels[0], paddingPixels[1], paddingPixels[2], paddingPixels[3]);
    }

    private void init() {
        inflate(getContext(), R.layout.full_cover_view, this);
        ...
        directionDetector =
            new SwipeDirectionDetector(getContext()) {
                @Override
    ...
    public void setPageChangeListener(ViewPager.SimpleOnPageChangeListener pageChangeListener) {
