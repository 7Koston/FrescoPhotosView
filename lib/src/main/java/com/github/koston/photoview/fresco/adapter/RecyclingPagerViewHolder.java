...
public abstract class RecyclingPagerViewHolder {

    private static final String STATE = RecyclingPagerViewHolder.class.getSimpleName();
    ...
    protected RecyclingPagerViewHolder(View itemView) {
        if (itemView == null) {
